...
//        self.projects.append(Project(id: 3, name: "Car", commIDs: [98,1001,32]))
    ...
    func outlineView(outlineView: NSOutlineView, viewForTableColumn tableColumn: NSTableColumn?, item: AnyObject) -> NSView? {
        ...
        if let project = item as? Project {
            ...
            view = self.outlineView.makeViewWithIdentifier("ProjectCell", owner: self) as? NSTableCellView
            ...
            if tableColumn?.identifier == "MainColumn" {
            view = self.outlineView.makeViewWithIdentifier("CommunityCell", owner: self) as? NSTableCellView
            if let textField = view?.textField {
